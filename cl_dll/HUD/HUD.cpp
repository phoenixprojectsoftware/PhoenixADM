...
void PrintVersion()
{
	...
	gEngfuncs.Con_Printf("\n  Half-Life: Zombies Ate My Neighbours %s", clientBuild);
...
void PrintWatermark()
{
	gEngfuncs.pfnDrawString(ScreenWidth / 20, gHUD.m_scrinfo.iCharHeight, "ZAMNHL build 2102-rev2", 54, 146, 248);
}
...
//	HOOK_COMMAND( "admsi_stop", ADMSIStop );
	...
	gEngfuncs.pfnAddCommand("adm_dev_watermark_manual", PrintWatermark);
